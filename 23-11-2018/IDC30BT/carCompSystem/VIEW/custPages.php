...
<html>
    ...
    <body class ="body">
        <div class="mHeader">
            &nbsp;&nbsp;<span class="style10"><strong>CAR COMPARING SYSTEM<?php echo $_SESSION['username']; ?> </strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <img  Height="90px" src="/Images/cclogo.gif" Width="200px" />
                    ...
                    <div class="menu"> 
                        ...
                        <ul>
                            ...
                            <li><a href="?controller=customer&action=updateCustomer"> UPDATE</a></li>
                            <li><a href="?controller=customer&action=view">VIEW CARS</a></li>
